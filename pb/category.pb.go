...
const file_category_proto_rawDesc = "" +
	...
	"\x0eListCategories\x12\x1f.category.ListCategoriesRequest\x1a .category.ListCategoriesResponseB>Z<github.com/DanielChachagua/ecommerce-noagestion-protos/pb;pbb\x06proto3"
...
var file_category_proto_goTypes = []any{
	...
	(*ListCategoriesRequest)(nil),  // 1: category.ListCategoriesRequest
	(*ListCategoriesResponse)(nil), // 2: category.ListCategoriesResponse
}
var file_category_proto_depIdxs = []int32{
	0, // 0: category.ListCategoriesResponse.categories:type_name -> category.Category
	1, // 1: category.CategoryService.ListCategories:input_type -> category.ListCategoriesRequest
	2, // 2: category.CategoryService.ListCategories:output_type -> category.ListCategoriesResponse
